...
class GaussianDiffusion:
  ...
  def q_mean_variance(self, x_start, t):
    ...
    """
    mean = (_ext(self.sqrt_alphas_cumprod, t, x_start.shape) * x_start)
    variance = _ext(1.0 - self.alphas_cumprod, t, x_start.shape)
    log_variance = _ext(self.log_one_minus_alphas_cumprod, t, x_start.shape)
  ...
  def q_sample(self, x_start, t, noise=None):
    ...
    return (
        _ext(self.sqrt_alphas_cumprod, t, x_start.shape) * x_start
        + _ext(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape)
        * noise
    )
  ...
  def q_posterior_mean_variance(self, x_start, x_t, t):
    ...
    posterior_mean = (
        _ext(self.posterior_mean_coef1, t, x_t.shape) * x_start
        + _ext(self.posterior_mean_coef2, t, x_t.shape) * x_t
    )
    posterior_variance = _ext(self.posterior_variance, t, x_t.shape)
    posterior_log_variance_clipped = _ext(self.posterior_log_variance_clipped, t, x_t.shape)
    assert (
  ...
  def _predict_xstart_from_xprev(self, x_t, t, xprev):
    ...
    return (  # (xprev - coef2*x_t) / coef1
        _ext(1.0 / self.posterior_mean_coef1, t, x_t.shape) * xprev
        - _ext(
  ...
  def _predict_eps_from_xstart(self, x_t, t, pred_xstart):
    return (
        ...
        - pred_xstart
    ) / _ext(self.sqrt_recipm1_alphas_cumprod, t, x_t.shape)
