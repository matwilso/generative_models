...
STUDENT=logs/1114/student_b
STUDENT_ARGS="--model diffusion_model --epochs 50"
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 3e-4 --lr_scheduler none   --adam_ema 0.999 --teacher_path $TEACHER/model.pt --teacher_mode step1 --logdir $STUDENT/256 --timesteps 256
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/256/model.pt --teacher_mode step2 --logdir $STUDENT/128 --timesteps 128
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/128/model.pt --teacher_mode step2 --logdir $STUDENT/64 --timesteps 64
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/64/model.pt --teacher_mode step2 --logdir $STUDENT/32 --timesteps 32
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/32/model.pt --teacher_mode step2 --logdir $STUDENT/16 --timesteps 16
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/16/model.pt --teacher_mode step2 --logdir $STUDENT/8 --timesteps 8
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/8/model.pt --teacher_mode step2 --logdir $STUDENT/4 --timesteps 4
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/4/model.pt --teacher_mode step2 --logdir $STUDENT/2 --timesteps 2
python /home/matwilso/code/generative_models/gms/main.py $STUDENT_ARGS --lr 1e-4 --lr_scheduler linear --adam_ema 0.0 --teacher_path $STUDENT/2/model.pt --teacher_mode step2 --logdir $STUDENT/1 --timesteps 1
