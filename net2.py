...
class ResNet18Enc(nn.Module):
    ...
    def __init__(self, num_Blocks=[2,2,2,2], H=None, nc=3):
        super().__init__()
        self.H = H
        self.in_planes = 64
        self.z_dim = H.z_size
        ...
        self.linear = nn.Linear(512, 2 * self.z_dim)
...
class VAE(nn.Module):
    ...
    def __init__(self, H):
        super().__init__()
        self.encoder = ResNet18Enc(z_dim=H.z_size)
        self.decoder = ResNet18Dec(z_dim=H.z_size)
